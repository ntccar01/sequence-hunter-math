const lessons = [
  ...
  },
  {
    ...
    studentTask: "學生端完成「等比數列與公比」章節：等比概念、找公比、寫前 5 項、辨認 a1 與 r、判斷是否等比。",
    checklist: [
  ...
  },
  {
    ...
    timeline: [
      ...
      ["12-22", "公式定位", "把 aₙ=a₁×rⁿ⁻¹ 拆成 a₁、r、n 三個欄位。"],
  ...
  },
  {
    ...
    tag: "第 3 節",
    title: "插入等比項",
    subtitle: "3-2 p.5｜插入項、總項數、公比反推",
    goals: [
      "能把插入幾個數轉成完整等比數列的總項數。",
      "能判斷兩端數字分別是第 1 項與最後一項。",
      "能用末項與首項反推公比。",
      "能依公比找出插入的各項。"
    ],
    guideIntro: "這一節先不要急著解高次方，先讓學生把「插入幾個數」畫成完整項數。等項數看清楚後，再用等比一般項反推公比。",
    guideBlocks: [
      {
        title: "先畫格子",
        example: "16, □, □, □, 81",
        talk: "插入 3 個數時，兩端也要一起算，所以完整數列共有 5 項。",
        feature: true
      },
      {
        title: "兩端是線索",
        example: "a1=16，a5=81",
        talk: "先把左端當首項，右端當最後一項，寫在格子上方。"
      },
      {
        title: "相差幾個公比",
        example: "第 1 項到第 5 項",
        talk: "從第 1 項到第 5 項，中間乘了 4 次公比，所以會出現 r⁴。"
      },
      {
        title: "列出關係式",
        example: "a₅=a₁×r⁴",
        talk: "讓學生先完成列式，再討論怎麼找 r。低成就學生只要先會列式就已經往前一步。"
      },
      {
        title: "公比可能正負",
        example: "r=3/2 或 -3/2",
        talk: "兩端都是正數且乘的次數是偶數時，公比可能有正、負兩種。先讓學生知道會有兩條路。"
      },
      {
        title: "再逐項乘出來",
        example: "16 → 24 → 36",
        talk: "找到公比後，不要跳到答案，從首項開始一格一格乘。"
      },
      {
        title: "找指定插入項",
        example: "插入第 2 個數",
        talk: "插入第 1 個數是完整數列第 2 項，插入第 2 個數是完整數列第 3 項。"
      },
      {
        title: "用學習單保留過程",
        example: "格子、r、逐項",
        talk: "這類題目最容易跳步，要求學生一定先完成格子圖再送答案。"
      }
    ],
    timeline: [
      ["0-5", "登入與回顧", "回顧等比一般項：第 n 項是 a₁ 乘 rⁿ⁻¹。"],
      ["5-12", "插入題讀題", "用格子圖說明插入 3 個數時總共有 5 項。"],
      ["12-22", "公比反推", "從 a₅=a₁×r⁴ 建立兩端數字與公比的關係。"],
      ["22-31", "老師示範", "示範在 4 與 32 之間插入 2 個數，使成等比數列。"],
      ["31-37", "正負公比提醒", "只提醒可能有正負兩種，不做過多計算延伸。"],
      ["37-42", "投放學生任務", "學生完成插入等比項章節，先畫格子再送答案。"],
      ["42-45", "冷卻整理", "學生寫一句：插入題要先算完整項數。"]
    ],
    demoQuestion: "在 4 與 32 之間插入 2 個數，使其成等比數列，請寫出這 2 個數。",
    demoSteps: [
      "先畫 4 格：4, □, □, 32。",
      "所以 a1=4，a4=32，從第 1 項到第 4 項共乘 3 次公比。",
      "列式：32=4×r³。",
      "先想 r³ 要等於多少，再找 r。",
      "從 4 開始每次乘 r，逐項填入兩個空格。"
    ],
    observe: [
      "學生是否知道插入 2 個數後完整數列共有 4 項。",
      "學生是否把插入第幾個數和完整數列第幾項混淆。",
      "學生是否能先列式再找公比。",
      "學生是否漏掉負公比可能性。"
    ],
    studentTask: "學生端完成「插入等比項」章節：總項數、反推公比、逐項填格與指定插入項。",
    checklist: [
      "戰情室確認插入等比項任務完成率。",
      "若總項數錯很多，下節先補插入格子圖。",
      "若負公比錯很多，先把正負兩條數列分開示範。"
    ]
  },
  {
    id: "lesson-3-2-4",
    tag: "第 4 節",
    title: "等比中項與等比級數概念",
    subtitle: "3-2 p.6｜等比中項、幾何平均、等比級數",
    goals: [
      "能說出等比中項是讓三個數成等比的中間數。",
      "能用 b²=ac 判斷或求等比中項。",
      "能知道等比中項可能有正、負兩個。",
    ...
    guideIntro: "這一節分成兩段：先處理等比中項，再用前面 Σ 的經驗銜接等比級數概念。重點先放理解，不急著進入等比級數和公式。",
    guideBlocks: [
      {
        title: "三個數成等比",
        example: "a, b, c",
        talk: "讓學生先看位置：b 是中間項，要讓 a 到 b、b 到 c 的倍數一致。",
        feature: true
      },
      {
        title: "用比例想",
        example: "b/a = c/b",
        talk: "等比中項的意思是左右兩邊的比相同。先口語說明，再慢慢變成式子。"
      },
      {
        title: "變成公式",
        example: "b²=ac",
        talk: "由 b/a=c/b 可以得到 b²=ac。學生先會用，不必要求完整推導。"
      },
      {
        title: "可能有兩個",
        example: "b=±√ac",
        talk: "這是本節最容易漏掉的地方。若 ac 是正數，正負兩個 b 都可能讓三數成等比。"
      },
      {
        title: "先檢查正負",
        example: "4, 8, 16；4, -8, 16",
        talk: "兩組都可以是等比，因為公比分別是 2 和 -2。"
      },
      {
        title: "等比級數是相加",
        example: "3+6+12+24",
        talk: "等比數列是排出來，等比級數是把等比數列各項加起來。"
      },
      {
        title: "Sn 表示前 n 項和",
        example: "S4=3+6+12+24",
        talk: "先只建立 Sn 的意思，公式留到下一節。"
      },
      {
        title: "用展開穩住概念",
        example: "a1+a2+...+an",
        talk: "學生先會展開和辨認，再進入求和公式會比較穩。"
      }
    ],
    timeline: [
      ["0-5", "登入與回顧", "回顧等比是倍數固定，請學生說出公比怎麼算。"],
      ["5-15", "等比中項概念", "用 4, □, 16 說明中間數要讓左右倍數一樣。"],
      ["15-24", "公式與正負", "帶出 b²=ac，提醒正負兩個中項。"],
      ["24-32", "老師示範", "示範求 9 與 81 的等比中項，刻意保留正負檢查。"],
      ["32-37", "等比級數概念", "用 3,6,12,24 對照 3+6+12+24。"],
      ["37-42", "投放學生任務", "學生完成等比中項與等比級數概念章節。"],
      ["42-45", "冷卻整理", "學生寫一句：數列是排隊，級數是相加。"]
    ],
    demoQuestion: "試求 9 與 81 的等比中項，並說明為什麼可能有兩個。",
    demoSteps: [
      "設等比中項為 b。",
      "使用 b²=ac，把 a=9、c=81 放入。",
      "先算 ac，再判斷 b 的正負可能。",
      "得到 b 後，用 9, b, 81 檢查左右公比是否相同。",
      "提醒：若只寫正數，要再檢查負數是否也成立。"
    ],
    observe: [
      "學生是否把等比中項和等差中項混用。",
      "學生是否只寫一個正中項，漏掉負中項。",
    ...
    studentTask: "學生端完成「等比中項與級數概念」章節：中項公式、正負中項、等比級數概念與逐項展開。",
    checklist: [
      "戰情室確認等比中項題是否集中錯在漏負號。",
      "若學生混淆等差中項，先用平均與乘積兩張對照卡補強。",
      "下一節可進入等比級數和公式。"
    ]
  }
];
